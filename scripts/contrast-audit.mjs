...
const PAIRS = [
  ...
  ["Score tile copy on pale band", T.ink, T.pale, "sm"],
  ["Score tile caption on pale", T.ink3, T.pale, "sm"],
  ["Diagnostics fail on danger tint", T.danger, "#fdf3f5", "sm"],
  ["Diagnostics warn on amber tint", T.warning, "#fff3e0", "sm"],
  ["Success on success tint", T.success, "#eaf7ee", "sm"],
  ["Chat user bubble on pale-2", T.ink, T.pale2, "sm"],
  ["Advisor headline on white", T.ink, T.white, "sm"],
  ["Recommended figure on pale", T.navy, T.pale, "sm"],
